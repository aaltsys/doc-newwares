...
*How can I set a minimum recurring invoice amount for an account?*
   ...
   **1S** and this invoice number, and sum the extended column to determine an 
   amount. Method logic will return **Amount = 0** when recurring exceeds 
   250.00, or when an invoice has no recurring charges. 
   ...
   **Minimum** is the minimum amount of recurring to charge, if any.
   ...
   Applying the rate as shown will result in a deficit charge line on an invoice 
   where the recurring total is greater than zero, but less than $250.00.
