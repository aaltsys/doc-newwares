...
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | condition        | M   | A   | SERIAL_LIST    ("G") | <,,9>          |
+-------+------------------+-----+-----+----------------------+----------------+
|   F   | account          | S   | A   | ACCOUNT              |                |
+-------+------------------+-----+-----+----------------------+----------------+
|   F   | product          | S   | A   | PRODUCT              |                |
...
|  N/A  | variety          | S   | A   | "null"               |                |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | controlCode      | S   | A   | SERIAL_LIST   (null) | <,,13>         |
+-------+------------------+-----+-----+----------------------+----------------+
|   F   | control          | S   | A   | CONTROL              |                |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | description      | M   | A   | SERIAL_LIST   (null) | <,,15>         |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | unitUom          | M   | A   | SERIAL_LIST   (null) | <,,16>         |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | unitNet          | M   | N   | SERIAL_LIST   (null) | <,,17> (MD2L)  |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | unitTare         | M   | N   | SERIAL_LIST   (null) | <,,18> (MD2L)  |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | unitSize         | M   | N   | SERIAL_LIST   (null) | <,,19> (MD4L)  |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | unitStack        | M   | N   | SERIAL_LIST   (null) | <,,20> (MD0)   |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | contentUom       | M   | A   | SERIAL_LIST   (null) | <,,21>         |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | contentCount     | M   | N   | SERIAL_LIST   (null) | <,,22> (MD0)   |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | contentReserve   | M   | N   | SERIAL_LIST   (null) | <,,23> (MD0)   |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | contentNet       | M   | N   | SERIAL_LIST   (null) | <,,24> (MD24L) |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | contentTare      | M   | N   | SERIAL_LIST   (null) | <,,25> (MD24L) |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | contentSize      | M   | N   | SERIAL_LIST   (null) | <,,26> (MD24L) |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | innerUom         | M   | A   | SERIAL_LIST   (null) | <,,27>         |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | innerCount       | M   | N   | SERIAL_LIST   (null) | <,,28> (MD0)   |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | innerReserve     | M   | N   | SERIAL_LIST   (null) | <,,29> (MD0)   |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | innerWeight      | M   | N   | SERIAL_LIST   (null) | <,,30> (MD24L) |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | innerSize        | M   | N   | SERIAL_LIST   (null) | <,,31> (MD24L) |
+-------+------------------+-----+-----+----------------------+----------------+
