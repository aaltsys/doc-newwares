...
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | unitSize         | S   | N   | "null"               | (MD4L)         |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | unitStack        | S   | N   | (filled in)          | (MD0)          |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | contentUom       | S   | A   | UOM_PIECE ("EA")     |                |
+-------+------------------+-----+-----+----------------------+----------------+
|   F   | contentCount     | S   | N   | FACT_STORE           | (MD0)          |
+-------+------------------+-----+-----+----------------------+----------------+
|   F   | contentNet       | S   | N   | FACT_WEIGHT          | (MD22L)        |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | contentTare      | S   | N   | FACT_TARE            | (MD22L)        |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | contentSize      | S   | N   | FACT_VOLUME          | (MD24L)        |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | innerUom         | S   | A   | UOM_INNER            |                |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | innerCount       | S   | N   | PROD_PACK            | (MD0)          |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | innerWeight      | S   | N   | INNERS_WEIGHT        | (MD24L)        |
+-------+------------------+-----+-----+----------------------+----------------+
|   J   | innerSize        | S   | N   | "null"               | (MD24L)        |
+-------+------------------+-----+-----+----------------------+----------------+
