...
| -- -- -- -- -- -- -- -- -- -- -- -- Keys                                       |
+---+---+----------------+-----+---+------------------------+--------+-----+-----+
| M | S | TYPE           | LC  | U | :ref:`document-list`   |        | L4  | [1]_|
+---+---+----------------+-----+---+------------------------+--------+-----+-----+
| M | S | IDENTIFIER     | SK  | U |                        |        | L12 | [2]_|
+---+---+----------------+-----+---+------------------------+--------+-----+-----+
| M | S | REVISION       | S   | U |                        |[1]_    | L4  | [2]_|
+---+---+----------------+-----+---+------------------------+--------+-----+-----+
| -- -- -- -- -- -- -- -- -- -- -- -- Posting & Reference                        |
+---+---+----------------+-----+---+------------------------+--------+-----+-----+
...
+---+---+----------------+-----+---+------------------------+--------+-----+-----+
| P | AM| REFERENCECODE  | LC  | U | :ref:`reference-list`  |        | L4  | [3]_|
+---+---+----------------+-----+---+------------------------+--------+-----+-----+
| P | AM| REFERENCE      | A   |   |                        |        | L20 |     |
+---+---+----------------+-----+---+------------------------+--------+-----+-----+
| -- -- -- -- -- -- -- -- -- -- -- -- Transportation                             |
+---+---+----------------+-----+---+------------------------+--------+-----+-----+
| P | AM| ADDRESSCODE    | LC  | U | :REF:`contact-list`    | ST,SF  | L4  | [4]_|
+---+---+----------------+-----+---+------------------------+--------+-----+-----+
